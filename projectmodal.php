    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="Project1">Object Recognition Tool for Visually
                    Impaired</h5>
            ...
            <div class="modal-body">
                <p>
                    ...
                    <a href="assets\img\certificates\ijsrd.jpg" class="image-link"><img
                            src="assets\img\certificates\ijsrd.jpg" class="lozad"></a>
